  ...
  return (
    <div>
        ...
        <div className='flex flex-col p-3 h-full'>
            <div className='flex justify-between items-center bg-gray-700 p-8 rounded-t-lg'>
            ...
            <div className='flex  items-center justify-between w-full p-4 bg-gray-600 rounded-b-lg'>
                ...
                <div className='flex justify-around  items-center w-1/4 '>
                    <button 
                        className='text-white text-xs bg-teal-400 rounded-full py-2 w-32 '
                    >
                            {t("jobs.APPLY_NOW")}
                    </button>
